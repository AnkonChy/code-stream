...
const Footer = () => {
  return (
    <div className="bg-[#F2EDEF] w-full relative">
      {/* <div className="bg-[#FF006A] text-white rounded-3xl max-w-[1240px] mx-auto text-center p-12 h-[480px] absolute -top-[410px] inset-x-0">
        <h2 className="text-3xl md:text-[76px] font-semibold my-4 leading-tight">
          Ready To Book Your Next <br /> Event Pro?
        </h2>
        <p className="my-6 text-2xl md:text-[32px] capitalize">
          Get a price in seconds and secure your perfect host today.
        </p>
        <button className="bg-white text-[#FF006A] font-medium px-5 py-3 rounded-full hover:bg-gray-100 transition mt-4">
          Get An Instant Quote
        </button>
      </div> */}
      <footer className="max-w-[1240px] mx-auto py-12 bg-[#F2EDEF] h-[711px] pt-32">
        <div className="flex flex-col md:flex-row items-start justify-between gap-15">
          {/* Brand */}
          <div className="w-1/4">
            <h3 className="font-bold text-[22px] flex items-center gap-2 mb-3">
              <span role="img" aria-label="logo">
                <img src={logo} className="w-[35px] h-[40px]" alt="" />
              </span>
          ...
          <div className="w-3/12 space-y-3">
            ...
            <div className="flex flex-col items-start gap-2 space-y-3">
              <input
                type="email"
                placeholder="Enter Your Email"
                className="w-11/12 px-4 py-2 rounded-full focus:outline-none text-sm bg-white"
              />
              <button className="bg-none text-[#FF006A] px-10 py-2 rounded-full font-medium text-sm hover:bg-pink-600 transition border-2 border-[#FF006A">
                Subscribe
              </button>
            </div>
        ...
        <div className="mt-8 text-gray-500 text-sm flex items-center justify-between">
